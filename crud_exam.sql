...
-- Dumping database structure for crud_exam
DROP DATABASE IF EXISTS `crud_exam`;
...
-- Dumping structure for table crud_exam.books
...
-- Dumping data for table crud_exam.books: ~1 rows (approximately)
DELETE FROM `books`;
INSERT INTO `books` (`id`, `title`, `isbn`, `author`, `publisher`, `year_published`, `category`) VALUES
	(2, 'test2', 'test', 'test', 'test', 0, 'test');
